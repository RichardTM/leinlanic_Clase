...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="/recintos/editar/{{$item->id}}" class="btn btn-success btn-sm"><i class="fas fa-user-edit"></i></a>
                                <a href="/recintos/crear" class="btn btn-success btn-sm"><i class="fas fa-user-plus"></i></a>
            ...
            <a href="/recintos/crear" class="btn btn-success"><i class="fas fa-user-plus"></i></a>
